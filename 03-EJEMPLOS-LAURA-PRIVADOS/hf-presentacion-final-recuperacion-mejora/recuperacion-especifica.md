...
```text
No hay recuperación específica pendiente en este ejemplo modelo.
```

Si hubiera RA pendiente, usaría esta estructura:

| RA pendiente | Evidencia nueva | Defensa |
|---|---|---|
| PR RA3 | Rehacer pruebas H2 | Explicar bucle, decisión y salida. |
| diagramas de clases | Mejorar diagrama H4 | Relacionar clase con código. |

Decisión docente simulada:

```text
Cierre válido sin recuperación específica.
```
