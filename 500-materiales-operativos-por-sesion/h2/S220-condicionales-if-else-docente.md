...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Menú parcial funcional.
...
`if`, `else if`, `else` y orden de evaluación.
...
| 40–45 min | Cierre: Pregunta: ¿qué rama se ejecuta con un comando inventado? |

## Ejemplo o demostración preparada

Rama para `ayuda`, `estado` y `else`.

## Consigna que se entrega al alumnado

Implementar tres comandos.

Producto o evidencia que debe quedar: **Menú parcial funcional.**
...
Pregunta de control: **¿Para qué sirve el último `else`?**
