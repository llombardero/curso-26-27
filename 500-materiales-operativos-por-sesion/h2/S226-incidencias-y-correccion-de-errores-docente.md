...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/incidencia-h2.md`.
...
Una incidencia no es un fracaso; es evidencia de aprendizaje.
...
Incidencia típica: `salir` no termina porque no cambia `running`.
...
Pregunta de control: **¿Cómo sabes que la solución arregló el problema?**
