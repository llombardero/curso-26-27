...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/pruebas-h2.md`.
...
Caso de prueba, entrada, resultado esperado, resultado obtenido e incidencia.
...
| 5–13 min | Explicación breve: Probar es comparar resultado esperado con resultado obtenido. |
| 13–18 min | Demostración o ejemplo: Caso: entrada `ayuda`, esperado: lista de comandos. |
| 18–35 min | Trabajo del alumnado: Crear plan de pruebas para todos los comandos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Ejecutar al menos un caso delante de otro equipo. |

## Ejemplo o demostración preparada

Caso: entrada `ayuda`, esperado: lista de comandos.

## Consigna que se entrega al alumnado

Crear tabla de pruebas H2.

Producto o evidencia que debe quedar: **`docs/pruebas-h2.md`.**
...
Pregunta de control: **¿Qué prueba demuestra que comando desconocido está controlado?**
