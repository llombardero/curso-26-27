...
3. Realiza esta tarea: **Añadir variable de control al programa.**
...
- [ ] He producido o actualizado: **Código preparado para repetir ejecución.**
...
Responde sin copiar: **Pregunta: ¿cuándo debe cambiar `running` a `false`?**
