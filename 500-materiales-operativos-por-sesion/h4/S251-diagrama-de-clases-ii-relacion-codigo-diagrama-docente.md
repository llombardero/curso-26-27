# Sesión 251 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/relacion-diagrama-codigo-h4.md`.
...
Todo elemento del diagrama debe poder localizarse en el código o justificarse como diseño pendiente.
...
| 5–13 min | Explicación breve: Un diagrama inventado no sirve; debe corresponder al código. |
| 13–18 min | Demostración o ejemplo: Señala un atributo del diagrama y localízalo en Java. |
| 18–35 min | Trabajo del alumnado: Completar relación diagrama-código. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Señalar una relación del diagrama en el código real. |

## Ejemplo o demostración preparada

Señala un atributo del diagrama y localízalo en Java.

## Consigna que se entrega al alumnado

Completar documento relación diagrama-código.

Producto o evidencia que debe quedar: **`docs/relacion-diagrama-codigo-h4.md`.**
...
Pregunta de control: **¿Dónde está en código esta relación?**
