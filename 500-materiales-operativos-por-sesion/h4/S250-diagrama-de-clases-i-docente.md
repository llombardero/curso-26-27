...
Clase, atributo, método y relación en diagrama.
...
| 5–13 min | Explicación breve: UML básico ayuda a comunicar diseño. |
| 13–18 min | Demostración o ejemplo: Caja con nombre, atributos y métodos. |
| 18–35 min | Trabajo del alumnado: Dibujar diagrama de clases actual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar si el diagrama coincide con el código. |

## Ejemplo o demostración preparada

Caja con nombre, atributos y métodos.
...
Pregunta de control: **¿Aparece en el diagrama algo que no exista en el código?**
