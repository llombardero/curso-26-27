# Sesión 257 — Guía operativa del profesorado
...
En POO se defiende diseño, no solo código que funciona.
...
| 5–13 min | Explicación breve: Defensa POO exige explicar clases, objetos, responsabilidades y relaciones. |
| 13–18 min | Demostración o ejemplo: Defensa modelo sobre `Memory`. |
| 18–35 min | Trabajo del alumnado: Defensa individual sobre clase, objeto, atributo, método, constructor, encapsulación y relaciones. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Decidir si el equipo está preparado para extensibilidad H5. |

## Ejemplo o demostración preparada

Defensa modelo sobre `Memory`.
...
Pregunta de control: **¿Puedes explicar una clase sin leer literalmente el código? ---**
