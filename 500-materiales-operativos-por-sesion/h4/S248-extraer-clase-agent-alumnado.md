...
|---|---|
| Sacar flujo principal de `Main`. | `Main` queda reducido a crear y lanzar el agente. |
...
3. Realiza esta tarea: **Crear `Agent` con método de ejecución.**
...
- [ ] He producido o actualizado: **`Main` queda reducido a crear y lanzar el agente.**
...
Responde sin copiar: **Pregunta: ¿qué responsabilidad conserva `Main`?**
