# Sesión 276 — Guía operativa del profesorado

## Defensa individual C2
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Registro de defensa individual.
...
La evidencia de equipo no sustituye la defensa individual.
...
| 5–13 min | Explicación breve: La defensa individual valida lo que cada persona entiende del trabajo grupal. |
| 13–18 min | Demostración o ejemplo: Preguntas sobre `Agent`, `Memory`, `Tool`, Git y pruebas. |
| 18–35 min | Trabajo del alumnado: Preguntas sobre clases, interfaces, refactorización, commits y pruebas. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Marcar recuperación o mejora. |

## Ejemplo o demostración preparada

Preguntas sobre `Agent`, `Memory`, `Tool`, Git y pruebas.

## Consigna que se entrega al alumnado

Defensa individual.

Producto o evidencia que debe quedar: **Registro de defensa individual.**
...
Pregunta de control: **¿Qué aportación concreta puedes demostrar?**
