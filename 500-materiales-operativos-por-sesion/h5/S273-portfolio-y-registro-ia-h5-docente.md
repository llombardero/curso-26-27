# Sesión 273 — Guía operativa del profesorado

## Portfolio y registro IA H5
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Portfolio H5 y registro IA.
...
La IA puede sugerir refactorizaciones, pero deben verificarse y defenderse.
...
| 5–13 min | Explicación breve: Si IA ayudó a refactorizar o sugerir patrones, debe quedar registrado y verificado. |
| 13–18 min | Demostración o ejemplo: Registro de prompt de refactorización. |
...
| 40–45 min | Cierre: Pregunta: ¿qué sugerencia de IA rechazaste o modificaste? |

## Ejemplo o demostración preparada

Registro de prompt de refactorización.

## Consigna que se entrega al alumnado

Completar portfolio y registro.

Producto o evidencia que debe quedar: **Portfolio H5 y registro IA.**
...
Pregunta de control: **¿Qué parte aceptaste y qué modificaste tú?**
