...
|---|---|
| Verificar que la extensibilidad no rompe H4. | Checklist de pruebas H5. |
...
3. Realiza esta tarea: **Ejecutar pruebas de comandos y memoria.**
...
- [ ] He producido o actualizado: **Checklist de pruebas H5.**
...
Responde sin copiar: **Registrar una regresión si aparece.**
