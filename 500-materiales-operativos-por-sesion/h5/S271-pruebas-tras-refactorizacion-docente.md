...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Checklist de pruebas H5.
...
Toda refactorización necesita comprobación posterior.
...
| 5–13 min | Explicación breve: Toda mejora estructural necesita pruebas de regresión. |
| 13–18 min | Demostración o ejemplo: Ejecutar comandos antes y después de extraer herramientas. |
| 18–35 min | Trabajo del alumnado: Ejecutar pruebas de comandos y memoria. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Registrar una regresión si aparece. |

## Ejemplo o demostración preparada

Ejecutar comandos antes y después de extraer herramientas.

## Consigna que se entrega al alumnado

Checklist de pruebas H5.

Producto o evidencia que debe quedar: **Checklist de pruebas H5.**
...
Pregunta de control: **¿Qué funcionalidad podría haberse roto?**
