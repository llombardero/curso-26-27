...
Defender es razonar sobre código, decisiones, errores y aprendizaje.
...
| 5–13 min | Explicación breve: La defensa se prepara entendiendo, no memorizando. |
| 13–18 min | Demostración o ejemplo: Simulación de pregunta inesperada sobre código. |
| 18–35 min | Trabajo del alumnado: Simulación de preguntas por parejas o tríos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Cada alumno anota tres preguntas que debe preparar mejor. |

## Ejemplo o demostración preparada

Simulación de pregunta inesperada sobre código.
...
Pregunta de control: **¿Qué pregunta todavía te cuesta responder?**
