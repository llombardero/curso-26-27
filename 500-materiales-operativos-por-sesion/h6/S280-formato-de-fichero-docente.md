...
| Resultado de hoy | Decidir cómo guardar datos. |
| Evidencia mínima | Documento de formato. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Documento de formato.
...
Formato simple, legible y suficiente: una línea por recuerdo.
...
| 5–13 min | Explicación breve: Un formato simple facilita leer, probar y depurar. |
| 13–18 min | Demostración o ejemplo: `data/recuerdos.txt`, una línea por recuerdo. |
| 18–35 min | Trabajo del alumnado: Diseñar `data/recuerdos.txt`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar si el formato puede leerse después. |

## Ejemplo o demostración preparada

`data/recuerdos.txt`, una línea por recuerdo.

## Consigna que se entrega al alumnado

Diseñar formato y ejemplos ficticios.

Producto o evidencia que debe quedar: **Documento de formato.**
...
Pregunta de control: **¿Cómo sabrás leer ese formato después?**
