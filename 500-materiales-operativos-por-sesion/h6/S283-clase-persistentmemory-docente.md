# Sesión 283 — Guía operativa del profesorado
...
| Resultado de hoy | Separar persistencia de memoria de negocio. |
| Evidencia mínima | Persistencia encapsulada en clase propia. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Persistencia encapsulada en clase propia.
...
La persistencia es una responsabilidad distinta.
...
| 5–13 min | Explicación breve: La persistencia debe estar separada de la interacción del agente. |
| 13–18 min | Demostración o ejemplo: `PersistentMemory` con `save` y `load`. |
| 18–35 min | Trabajo del alumnado: Crear o ajustar `PersistentMemory`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿por qué no ponemos todo en `Agent`? |

## Ejemplo o demostración preparada

`PersistentMemory` con `save` y `load`.

## Consigna que se entrega al alumnado

Encapsular lectura y escritura.

Producto o evidencia que debe quedar: **Persistencia encapsulada en clase propia.**
...
Pregunta de control: **¿Por qué no debe hacerlo todo `Agent`?**
