...
| Resultado de hoy | Evitar secretos y datos personales. |
| Evidencia mínima | `docs/seguridad-h6.md`. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/seguridad-h6.md`.
...
No subir `.env` real, tokens, claves ni datos personales.
...
| 5–13 min | Explicación breve: Nunca subir claves, `.env` real, tokens ni datos personales. |
| 13–18 min | Demostración o ejemplo: Diferencia entre `.env` y `.env.example`. |
| 18–35 min | Trabajo del alumnado: Revisar repositorio y ficheros de ejemplo. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Checklist de seguridad pasado. |
...
Revisar repositorio con checklist.

Producto o evidencia que debe quedar: **`docs/seguridad-h6.md`.**
...
Pregunta de control: **¿Qué harías si una clave se sube por error?**
