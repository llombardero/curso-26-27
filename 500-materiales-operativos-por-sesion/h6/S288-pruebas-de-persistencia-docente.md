...
La prueba clave de persistencia exige segunda ejecución.
...
| 5–13 min | Explicación breve: La prueba clave es segunda ejecución: guardar, cerrar, abrir, consultar. |
| 13–18 min | Demostración o ejemplo: Ejecutar prueba completa. |
| 18–35 min | Trabajo del alumnado: Completar pruebas: guardar, cerrar, abrir, consultar, fichero vacío y error. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Ejecutar prueba completa delante del docente o de otro equipo. |
...
Pregunta de control: **¿Qué prueba demuestra persistencia real?**
