...
| Resultado de hoy | Registrar eventos simples. |
| Evidencia mínima | Log generado sin datos sensibles. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Log generado sin datos sensibles.
...
Log no es base de datos; es trazabilidad básica.
...
| 5–13 min | Explicación breve: Un log registra eventos para trazabilidad, no debe guardar secretos. |
| 13–18 min | Demostración o ejemplo: Línea de log: fecha simple, acción, resultado. |
| 18–35 min | Trabajo del alumnado: Crear `logs/historial.log` con eventos simples. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar que el log no contiene información personal real. |

## Ejemplo o demostración preparada

Línea de log: fecha simple, acción, resultado.

## Consigna que se entrega al alumnado

Crear `logs/historial.log`.

Producto o evidencia que debe quedar: **Log generado sin datos sensibles.**
...
Pregunta de control: **¿Qué información no debe aparecer en el log?**
