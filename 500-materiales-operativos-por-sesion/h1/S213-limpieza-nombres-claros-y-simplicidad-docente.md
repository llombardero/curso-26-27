# Sesión 213 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código H1 limpio, simple y ejecutable.
...
Código limpio inicial: nombres, orden, comentarios útiles y ausencia de adornos.
...
| 5–13 min | Explicación breve: Código limpio en H1 significa que se entiende, no que sea avanzado. |
| 13–18 min | Demostración o ejemplo: Renombra `x` a `userName` y compara legibilidad. |
| 18–35 min | Trabajo del alumnado: Revisar el código H1 con una checklist sencilla. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué parte sobra o no sabes explicar? |

## Ejemplo o demostración preparada

Renombra `x` a `userName` y compara legibilidad.

## Consigna que se entrega al alumnado

Revisar nombres, orden y comentarios.

Producto o evidencia que debe quedar: **Código H1 limpio, simple y ejecutable.**
...
Pregunta de control: **¿Qué línea de tu código no sabes explicar?**
