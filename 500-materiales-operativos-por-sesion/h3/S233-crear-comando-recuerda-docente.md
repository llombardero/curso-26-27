...
| Resultado de hoy | Guardar información introducida por usuario. |
| Evidencia mínima | MiniJarvis guarda al menos un recuerdo. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: MiniJarvis guarda al menos un recuerdo.
- [ ] Dejar visible el objetivo y reservar los últimos 8 minutos para comprobar y cerrar.

## Material imprescindible

- Proyecto y portfolio del hito accesibles en el ordenador; no se requiere material físico adicional.

## Qué debes explicar

Añadir elementos a colección y confirmar acción.
...
| 5–13 min | Explicación breve: El comando debe pedir texto, validarlo y guardarlo. |
| 13–18 min | Demostración o ejemplo: Flujo: comando → pregunta → entrada → `add`. |
| 18–35 min | Trabajo del alumnado: Implementar comando `recuerda`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Probar guardar dos recuerdos seguidos. |

## Ejemplo o demostración preparada

Flujo: comando → pregunta → entrada → `add`.

## Consigna que se entrega al alumnado

Implementar `recuerda`.

Producto o evidencia que debe quedar: **MiniJarvis guarda al menos un recuerdo.**
...
Pregunta de control: **¿Dónde se guarda realmente el recuerdo?**
