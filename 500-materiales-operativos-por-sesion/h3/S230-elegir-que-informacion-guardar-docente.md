...
| Resultado de hoy | Definir memoria antes de codificar. |
| Evidencia mínima | Documento breve de decisión de memoria. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Documento breve de decisión de memoria.
...
No se elige colección sin saber qué datos se necesitan.
...
| 5–13 min | Explicación breve: La estructura de datos depende del tipo de información y de cómo se consultará. |
| 13–18 min | Demostración o ejemplo: Recuerdos simples frente a preferencias con clave. |
| 18–35 min | Trabajo del alumnado: Decidir si se guardan recuerdos, preferencias, mensajes o historial simple. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Cada equipo justifica qué información guardará. |

## Ejemplo o demostración preparada

Recuerdos simples frente a preferencias con clave.

## Consigna que se entrega al alumnado

Decidir datos de memoria del equipo.

Producto o evidencia que debe quedar: **Documento breve de decisión de memoria.**
...
Pregunta de control: **¿Necesitas orden, clave o búsqueda?**
