...
Criterio de cobertura curricular:
...
| Placeholder | H6 | H7-HF | Valor ficticio que muestra formato sin revelar secreto. | En plantillas y ejemplos. | `API_KEY=<valor-ficticio>`. |
