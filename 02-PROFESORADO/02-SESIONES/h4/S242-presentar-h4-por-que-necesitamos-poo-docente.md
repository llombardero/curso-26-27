...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Lista de problemas del código H3.
...
Todo en `Main` empieza a ser difícil de mantener.
...
| 5–13 min | Explicación breve: La POO aparece porque el código en `Main` mezcla demasiadas responsabilidades. |
| 13–18 min | Demostración o ejemplo: Señala en H3 partes de entrada, menú, memoria y salida mezcladas. |
| 18–35 min | Trabajo del alumnado: Revisar H3 y marcar responsabilidades mezcladas. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué responsabilidades distintas aparecen en nuestro programa? |

## Ejemplo o demostración preparada

Señala en H3 partes de entrada, menú, memoria y salida mezcladas.

## Consigna que se entrega al alumnado

Marcar responsabilidades con colores.

Producto o evidencia que debe quedar: **Lista de problemas del código H3.**
...
Pregunta de control: **¿Qué responsabilidad separarías primero?**
