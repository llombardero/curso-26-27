...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código con constructores sobrecargados y apartado en README/portfolio explicando cuándo se usa cada uno.
...
Constructor por defecto, constructor con parámetros, sobrecarga, uso de `this`, estado inicial válido y documentación Javadoc mínima.
...
| 5–13 min | Explicación breve: El constructor deja el objeto preparado para usarse. |
| 13–18 min | Demostración o ejemplo: `public Memory() { this.memories = new ArrayList<>(); }`. |
| 18–35 min | Trabajo del alumnado: Añadir a `Memory` un constructor por defecto y otro que reciba recuerdos iniciales ficticios; documentar con Javadoc una clase y dos métodos públicos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué constructor se ejecuta en tu `Main`? |

## Ejemplo o demostración preparada

`public Memory() { this.memories = new ArrayList<>(); }`.

## Consigna que se entrega al alumnado

Crear constructor de `Memory`.

Producto o evidencia que debe quedar: **Código con constructores sobrecargados y apartado en README/portfolio explicando cuándo se usa cada uno.**
