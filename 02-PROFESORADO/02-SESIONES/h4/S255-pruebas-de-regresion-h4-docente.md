...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Checklist de pruebas H4.
...
Refactorizar no debe cambiar lo que el usuario observa, salvo decisión explícita.
...
| 5–13 min | Explicación breve: Cambiar diseño no debe romper comportamiento ya logrado. |
| 13–18 min | Demostración o ejemplo: Ejecutar pruebas de H3 sobre código H4. |
| 18–35 min | Trabajo del alumnado: Reejecutar pruebas de H3 sobre diseño H4. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Registrar un fallo provocado por el rediseño si aparece. |

## Ejemplo o demostración preparada

Ejecutar pruebas de H3 sobre código H4.

## Consigna que se entrega al alumnado

Checklist de regresión.

Producto o evidencia que debe quedar: **Checklist de pruebas H4.**
...
Pregunta de control: **¿Qué comando funcionaba antes y debe seguir funcionando?**
