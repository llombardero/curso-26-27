...
## README, portfolio y registro IA H4
...
| Resultado de hoy | Documentar diseño OO. |
| Evidencia mínima | README H4, portfolio y registro IA. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: README H4, portfolio y registro IA.
...
README debe explicar clases principales y cómo ejecutar.
...
| 5–13 min | Explicación breve: En H4 hay que documentar diseño, no solo ejecución. |
| 13–18 min | Demostración o ejemplo: Sección README: clases principales y responsabilidades. |
| 18–35 min | Trabajo del alumnado: Actualizar README, portfolio y registro IA. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Otro equipo revisa si entiende el diseño leyendo el README. |

## Ejemplo o demostración preparada

Sección README: clases principales y responsabilidades.

## Consigna que se entrega al alumnado

Actualizar documentación.

Producto o evidencia que debe quedar: **README H4, portfolio y registro IA.**
...
Pregunta de control: **¿Puede otra persona entender tu diseño leyendo el README?**
