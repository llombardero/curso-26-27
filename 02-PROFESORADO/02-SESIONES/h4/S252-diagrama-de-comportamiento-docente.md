...
Flujo de un comando desde entrada hasta respuesta.
...
| 5–13 min | Explicación breve: Además de estructura, hay que explicar flujo. |
| 13–18 min | Demostración o ejemplo: Flujo del comando `recuerda`: usuario → Agent → Memory → respuesta. |
| 18–35 min | Trabajo del alumnado: Dibujar flujo de `recuerda` o `memoria`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué objeto actúa primero y cuál después? |

## Ejemplo o demostración preparada

Flujo del comando `recuerda`: usuario → Agent → Memory → respuesta.
...
Pregunta de control: **¿Qué objeto actúa primero?**
