# Sesión 243 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Definición propia de clase y objeto con ejemplo.
...
Clase como plantilla; objeto como instancia concreta.
...
| 5–13 min | Explicación breve: Una clase define estructura y comportamiento; un objeto es una instancia concreta. |
| 13–18 min | Demostración o ejemplo: Clase `Memory`; objeto `memory` creado con `new Memory()`. |
| 18–35 min | Trabajo del alumnado: Ejemplos fuera de MiniJarvis y luego dentro del proyecto. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿MiniJarvis podría ser un objeto? |

## Ejemplo o demostración preparada

Clase `Memory`; objeto `memory` creado con `new Memory()`.

## Consigna que se entrega al alumnado

Escribir dos ejemplos de clase y objeto del proyecto.

Producto o evidencia que debe quedar: **Definición propia de clase y objeto con ejemplo.**
...
Pregunta de control: **¿`Memory` es clase u objeto? ¿Y `memory`?**
