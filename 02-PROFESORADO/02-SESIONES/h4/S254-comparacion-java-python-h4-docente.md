...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/comparacion-java-python-h4.md`.
...
Visibilidad, constructor y convenciones en ambos lenguajes.
...
| 5–13 min | Explicación breve: Java usa visibilidad formal; Python usa convenciones. |
| 13–18 min | Demostración o ejemplo: Constructor Java frente a `__init__` en Python. |
| 18–35 min | Trabajo del alumnado: Analizar equivalencias de una clase simple. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué diferencia ves en encapsulación? |

## Ejemplo o demostración preparada

Constructor Java frente a `__init__` en Python.

## Consigna que se entrega al alumnado

Comparar `Memory` en ambos lenguajes.

Producto o evidencia que debe quedar: **`docs/comparacion-java-python-h4.md`.**
...
Pregunta de control: **¿Cómo se indica en Python que algo no debería tocarse desde fuera?**
