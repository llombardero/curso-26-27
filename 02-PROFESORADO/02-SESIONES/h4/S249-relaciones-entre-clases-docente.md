...
| Resultado de hoy | Entender colaboración entre objetos. |
| Evidencia mínima | Descripción textual de relaciones del diseño. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Descripción textual de relaciones del diseño.
...
Un objeto puede usar otro objeto para cumplir su responsabilidad.
...
| 5–13 min | Explicación breve: Los objetos colaboran. `Agent` usa `Memory`, pero no debe hacer su trabajo. |
| 13–18 min | Demostración o ejemplo: Diagrama simple `Main -> Agent -> Memory`. |
| 18–35 min | Trabajo del alumnado: Analizar relación `Agent` -> `Memory`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿quién debe guardar recuerdos, `Agent` o `Memory`? |

## Ejemplo o demostración preparada

Diagrama simple `Main -> Agent -> Memory`.

## Consigna que se entrega al alumnado

Describir relaciones del proyecto.

Producto o evidencia que debe quedar: **Descripción textual de relaciones del diseño.**
...
Pregunta de control: **¿Quién decide el flujo? ¿Quién guarda recuerdos?**
