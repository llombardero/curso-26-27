# Sesión 246 — Guía operativa del profesorado
...
| Resultado de hoy | Proteger datos internos. |
| Evidencia mínima | Código sin acceso directo innecesario a atributos. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código sin acceso directo innecesario a atributos.
...
`private`, métodos públicos y acceso controlado.
...
| 5–13 min | Explicación breve: Encapsular es proteger el estado interno y ofrecer operaciones controladas. |
| 13–18 min | Demostración o ejemplo: Cambiar lista pública por `private final List<String> memories`. |
| 18–35 min | Trabajo del alumnado: Hacer privada la colección de memoria y acceder mediante métodos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿por qué no dejamos la lista pública? |

## Ejemplo o demostración preparada

Cambiar lista pública por `private final List<String> memories`.

## Consigna que se entrega al alumnado

Hacer privados atributos y usar métodos públicos.

Producto o evidencia que debe quedar: **Código sin acceso directo innecesario a atributos.**
...
Pregunta de control: **¿Por qué no debe cualquiera modificar directamente la lista?**
