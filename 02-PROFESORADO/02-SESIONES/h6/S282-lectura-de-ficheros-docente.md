...
| Resultado de hoy | Cargar recuerdos al iniciar. |
| Evidencia mínima | Recuerdos recuperados tras reiniciar. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Recuerdos recuperados tras reiniciar.
...
Leer líneas y reconstruir memoria.
...
| 5–13 min | Explicación breve: Leer permite reconstruir memoria al iniciar. |
| 13–18 min | Demostración o ejemplo: `Files.readAllLines`. |
| 18–35 min | Trabajo del alumnado: Implementar carga inicial o comando de carga. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Prueba: guardar, cerrar, abrir y consultar. |
...
Cargar recuerdos desde fichero.

Producto o evidencia que debe quedar: **Recuerdos recuperados tras reiniciar.**
...
Pregunta de control: **¿Qué ocurre si el fichero está vacío?**
