...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Defensa H6.
...
El proyecto debe quedar cerrado en versión base antes de FFEOE.
...
| 5–13 min | Explicación breve: H6 se defiende demostrando guardar, cerrar, abrir y recuperar. |
| 13–18 min | Demostración o ejemplo: Demo completa de persistencia. |
| 18–35 min | Trabajo del alumnado: Demo de guardar, cerrar, abrir y consultar. Defensa individual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Decidir si el grupo puede abordar H7 o debe ir a cierre. |

## Ejemplo o demostración preparada

Demo completa de persistencia.

## Consigna que se entrega al alumnado

Defensa individual.

Producto o evidencia que debe quedar: **Defensa H6.**
...
Pregunta de control: **¿Dónde se guardan los datos y cómo se cargan? ---**
