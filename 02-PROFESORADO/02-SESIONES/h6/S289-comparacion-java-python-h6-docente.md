...
Diferencias entre APIs de fichero en Java y Python.
...
| 5–13 min | Explicación breve: Ambos lenguajes pueden leer y escribir ficheros; cambia la API y la verbosidad. |
| 13–18 min | Demostración o ejemplo: Java `Files.readAllLines` frente a Python `open`. |
| 18–35 min | Trabajo del alumnado: Analizar versión Python equivalente. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué parte es más sencilla en Python y por qué? |

## Ejemplo o demostración preparada

Java `Files.readAllLines` frente a Python `open`.
...
Pregunta de control: **¿Qué parte es más explícita en Java?**
