...
| Resultado de hoy | Documentar decisiones, seguridad y uso de IA. |
| Evidencia mínima | Portfolio H6 y registro IA. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Portfolio H6 y registro IA.
...
La IA puede ayudar con ficheros, pero hay que verificar rutas, errores y seguridad.
...
| 5–13 min | Explicación breve: Si IA ayuda con ficheros, revisar rutas, excepciones y seguridad. |
| 13–18 min | Demostración o ejemplo: Prompt para pedir explicación de `Files.writeString` y registro asociado. |
| 18–35 min | Trabajo del alumnado: Completar portfolio y registro IA. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué riesgo de seguridad has evitado? |

## Ejemplo o demostración preparada

Prompt para pedir explicación de `Files.writeString` y registro asociado.

## Consigna que se entrega al alumnado

Completar portfolio y registro.

Producto o evidencia que debe quedar: **Portfolio H6 y registro IA.**
...
Pregunta de control: **¿Qué verificaste antes de aceptar código de IA?**
