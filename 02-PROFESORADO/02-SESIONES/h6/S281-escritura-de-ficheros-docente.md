...
| Resultado de hoy | Guardar recuerdos en disco. |
| Evidencia mínima | `data/recuerdos.txt` generado con datos ficticios. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `data/recuerdos.txt` generado con datos ficticios.
...
Escritura de fichero y creación de carpeta `data/`.
...
| 5–13 min | Explicación breve: Escribir en fichero guarda datos fuera del programa. |
| 13–18 min | Demostración o ejemplo: `Files.writeString` con `CREATE` y `APPEND`. |
| 18–35 min | Trabajo del alumnado: Implementar guardado básico. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Verificar el contenido del fichero. |

## Ejemplo o demostración preparada

`Files.writeString` con `CREATE` y `APPEND`.

## Consigna que se entrega al alumnado

Guardar recuerdos en `data/recuerdos.txt`.

Producto o evidencia que debe quedar: **`data/recuerdos.txt` generado con datos ficticios.**
...
Pregunta de control: **¿Dónde se crea el fichero?**
