...
- [ ] Comprobar que la evidencia mínima que se pedirá es: README H6 probado por otro equipo.
...
Reproducible significa seguir pasos y obtener resultado.
...
| 5–13 min | Explicación breve: Reproducible significa que otra persona puede seguir pasos desde cero. |
| 13–18 min | Demostración o ejemplo: Probar README de otro equipo. |
| 18–35 min | Trabajo del alumnado: Redactar README H6 con estructura, ejecución y pruebas. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Si otro equipo no puede ejecutar, README incompleto. |

## Ejemplo o demostración preparada

Probar README de otro equipo.

## Consigna que se entrega al alumnado

Actualizar instrucciones H6.

Producto o evidencia que debe quedar: **README H6 probado por otro equipo.**
...
Pregunta de control: **¿Qué paso falta si otro equipo no puede ejecutar?**
