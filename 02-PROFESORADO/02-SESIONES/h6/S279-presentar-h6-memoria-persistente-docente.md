...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Necesidad documentada de persistencia.
...
Diferencia entre memoria temporal y fichero.
...
| 5–13 min | Explicación breve: Persistencia significa guardar información fuera de la memoria RAM del programa. |
| 13–18 min | Demostración o ejemplo: Guardar, cerrar, abrir y comprobar pérdida actual. |
| 18–35 min | Trabajo del alumnado: Ejecutar MiniJarvis, guardar recuerdo, cerrar y comprobar pérdida actual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué debe sobrevivir entre ejecuciones? |

## Ejemplo o demostración preparada

Guardar, cerrar, abrir y comprobar pérdida actual.

## Consigna que se entrega al alumnado

Definir qué debe persistir.

Producto o evidencia que debe quedar: **Necesidad documentada de persistencia.**
...
Pregunta de control: **¿Qué debe sobrevivir entre ejecuciones?**
