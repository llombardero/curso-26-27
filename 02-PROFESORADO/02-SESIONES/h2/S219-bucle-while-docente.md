...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Programa que repite prompt `>`.
...
Estructura `while (running)` y flujo de repetición.
...
| 5–13 min | Explicación breve: `while` repite mientras una condición sea verdadera. |
| 13–18 min | Demostración o ejemplo: Dibuja el ciclo: comprobar condición → ejecutar → volver a comprobar. |
| 18–35 min | Trabajo del alumnado: Implementar bucle que pide comandos hasta una condición. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Dibujar el flujo del bucle en pizarra o cuaderno. |

## Ejemplo o demostración preparada

Dibuja el ciclo: comprobar condición → ejecutar → volver a comprobar.

## Consigna que se entrega al alumnado

Crear prompt repetido `>`.

Producto o evidencia que debe quedar: **Programa que repite prompt `>`.**
...
Pregunta de control: **¿Qué puede provocar un bucle infinito?**
