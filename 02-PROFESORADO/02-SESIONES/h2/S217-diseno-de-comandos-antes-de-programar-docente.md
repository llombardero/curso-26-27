...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Tabla de comandos con respuesta esperada.
...
Un comando está bien definido si se puede probar.
...
| 5–13 min | Explicación breve: Antes de programar hay que saber qué debe ocurrir con cada comando. |
| 13–18 min | Demostración o ejemplo: Tabla comando-respuesta. |
| 18–35 min | Trabajo del alumnado: Completar tabla de comandos: `ayuda`, `saluda`, `estado`, `salir`, `otro`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar si todos los comandos tienen criterio de aceptación. |

## Ejemplo o demostración preparada

Tabla comando-respuesta.

## Consigna que se entrega al alumnado

Completar comandos `ayuda`, `saluda`, `estado`, `salir`, `otro`.

Producto o evidencia que debe quedar: **Tabla de comandos con respuesta esperada.**
...
Pregunta de control: **¿Cómo probarías el comando `estado`?**
