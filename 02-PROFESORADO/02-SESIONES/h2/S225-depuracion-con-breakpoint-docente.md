...
Breakpoint, variables observadas y ejecución paso a paso.
...
| 5–13 min | Explicación breve: Depurar permite ver valores internos mientras el programa se ejecuta. |
| 13–18 min | Demostración o ejemplo: Breakpoint después de leer `command`. |
| 18–35 min | Trabajo del alumnado: Poner breakpoint tras leer `command` y observar `command`, `running`, `userName`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué valor tenía `command` antes de entrar en el condicional? |

## Ejemplo o demostración preparada

Breakpoint después de leer `command`.
...
Pregunta de control: **¿Qué valor tenía `command` antes del condicional?**
