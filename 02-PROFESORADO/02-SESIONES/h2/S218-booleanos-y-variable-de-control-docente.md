...
| Resultado de hoy | Controlar si el programa sigue o termina. |
| Evidencia mínima | Código preparado para repetir ejecución. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código preparado para repetir ejecución.
...
| 5–13 min | Explicación breve: Un booleano representa verdadero/falso; servirá para controlar el bucle. |
| 13–18 min | Demostración o ejemplo: `boolean running = true;` y cambio a `false`. |
| 18–35 min | Trabajo del alumnado: Añadir variable de control al programa. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿cuándo debe cambiar `running` a `false`? |

## Ejemplo o demostración preparada

`boolean running = true;` y cambio a `false`.

## Consigna que se entrega al alumnado

Añadir variable `running`.

Producto o evidencia que debe quedar: **Código preparado para repetir ejecución.**
...
Pregunta de control: **¿Qué valor debe tener `running` al empezar?**
