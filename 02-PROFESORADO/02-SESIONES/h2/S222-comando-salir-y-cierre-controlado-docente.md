...
- [ ] Comprobar que la evidencia mínima que se pedirá es: El programa termina solo cuando se escribe `salir`.
...
Salida controlada, mensaje final y cambio de estado.
...
| 5–13 min | Explicación breve: Salir no es cortar el programa; es cambiar el estado para terminar bien. |
| 13–18 min | Demostración o ejemplo: `running = false` dentro de la rama `salir`. |
| 18–35 min | Trabajo del alumnado: Implementar `salir` modificando `running`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Prueba oral: ¿qué línea provoca la salida? |

## Ejemplo o demostración preparada

`running = false` dentro de la rama `salir`.

## Consigna que se entrega al alumnado

Implementar salida con mensaje final.

Producto o evidencia que debe quedar: **El programa termina solo cuando se escribe `salir`.**
...
Pregunta de control: **¿Dónde cambia el valor de `running`?**
