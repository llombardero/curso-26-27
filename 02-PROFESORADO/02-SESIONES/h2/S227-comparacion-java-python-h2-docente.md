...
La comparación busca comprensión, no memorizar Python.
...
Mostrar `while` en Java y Python.
...
Pregunta de control: **¿Dónde aparece el equivalente de `.equals()` en Python?**
