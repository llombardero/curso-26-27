...
La defensa puede pedir modificar un comando en directo.
...
| 5–13 min | Explicación breve: H2 se supera si el menú funciona, se prueba, se depura y se defiende. |
| 13–18 min | Demostración o ejemplo: Defensa modelo modificando un comando en directo. |
| 18–35 min | Trabajo del alumnado: Demo por equipo y defensa individual breve. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Lista de condiciones para poder empezar H3. |

## Ejemplo o demostración preparada

Defensa modelo modificando un comando en directo.
...
Pregunta de control: **¿Puedes añadir un comando simple sin ayuda? ---**
