# Sesión 241 — Guía operativa del profesorado

## Cierre C1: demo parcial y recuperación
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Checklist C1 con RA pendientes y plan de mejora.
...
Antes de entrar en clases, hay que dominar estructura, control de flujo y colecciones.
...
| 5–13 min | Explicación breve: Antes de POO deben estar claros `main`, bucles, condicionales y colecciones. |
| 13–18 min | Demostración o ejemplo: Mapa de requisitos mínimos H1-H3. |
| 18–35 min | Trabajo del alumnado: Demo parcial, revisión de evidencias y recuperación individual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Cada alumno identifica qué sabe defender y qué debe recuperar. |

## Ejemplo o demostración preparada

Mapa de requisitos mínimos H1-H3.

## Consigna que se entrega al alumnado

Demo parcial y plan de recuperación.

Producto o evidencia que debe quedar: **Checklist C1 con RA pendientes y plan de mejora.**
...
Pregunta de control: **¿Qué RA o evidencia tienes pendiente? ---**
