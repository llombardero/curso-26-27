# Sesión 211 — Guía operativa del profesorado
...
| Resultado de hoy | Diferenciar variable y constante. |
| Evidencia mínima | Código con al menos una constante bien usada. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código con al menos una constante bien usada.
...
`final`, nombres claros y datos que no deberían cambiar.
...
| 5–13 min | Explicación breve: Una constante representa un dato que no debe cambiar durante la ejecución. |
| 13–18 min | Demostración o ejemplo: `final String ASSISTANT_NAME = "MiniJarvis";`. |
| 18–35 min | Trabajo del alumnado: Añadir `ASSISTANT_NAME` y `COURSE_YEAR`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué dato de nuestro programa debería ser constante? |
...
Añadir nombre del asistente y año como constantes.

Producto o evidencia que debe quedar: **Código con al menos una constante bien usada.**
...
Pregunta de control: **¿Por qué `ASSISTANT_NAME` es mejor como constante que como texto repetido?**
