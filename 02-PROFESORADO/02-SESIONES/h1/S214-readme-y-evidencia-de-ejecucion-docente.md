# Sesión 214 — Guía operativa del profesorado
...
README mínimo: qué hace, cómo se ejecuta, ejemplo de salida y limitaciones.
...
| 5–13 min | Explicación breve: Un README permite que otra persona entienda y ejecute el proyecto. |
| 13–18 min | Demostración o ejemplo: Modelo mínimo: qué hace, cómo ejecutar, ejemplo de salida, limitaciones. |
| 18–35 min | Trabajo del alumnado: Crear `README.md` y evidencia de ejecución. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Intercambio: otro equipo intenta entender el README. |

## Ejemplo o demostración preparada

Modelo mínimo: qué hace, cómo ejecutar, ejemplo de salida, limitaciones.
...
Pregunta de control: **¿Podría otro compañero ejecutar tu proyecto leyendo solo el README?**
