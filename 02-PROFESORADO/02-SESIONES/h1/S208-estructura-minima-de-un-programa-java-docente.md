# Sesión 208 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Código que compila con varios mensajes por pantalla.
...
`public class Main`, `public static void main(String[] args)` y orden de ejecución.
...
| 5–13 min | Explicación breve: Java organiza el código en clases; `main` es el punto de entrada. |
| 13–18 min | Demostración o ejemplo: Señala línea a línea `public class Main` y `public static void main`. |
| 18–35 min | Trabajo del alumnado: Reescribir un programa mínimo y señalar dónde empieza. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Microdefensa: señalar en el código dónde empieza el programa. |

## Ejemplo o demostración preparada

Señala línea a línea `public class Main` y `public static void main`.

## Consigna que se entrega al alumnado

Escribir un programa mínimo sin copiar y ejecutarlo.

Producto o evidencia que debe quedar: **Código que compila con varios mensajes por pantalla.**
...
Pregunta de control: **¿Qué línea indica dónde empieza el programa?**
