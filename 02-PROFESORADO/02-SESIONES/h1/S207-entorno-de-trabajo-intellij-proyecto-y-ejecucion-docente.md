# Sesión 207 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Captura o documento de primera ejecución.
...
Código fuente, proyecto, JDK, compilación, ejecución y consola.
...
| 5–13 min | Explicación breve: Diferencia entre código fuente, proyecto, JDK, compilación y ejecución. |
| 13–18 min | Demostración o ejemplo: Crear proyecto y ejecutar `System.out.println("Hola")`. |
| 18–35 min | Trabajo del alumnado: Crear proyecto en IntelliJ, clase `Main` y primer `println`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Cada alumno localiza dónde está `Main.java`. |

## Ejemplo o demostración preparada

Crear proyecto y ejecutar `System.out.println("Hola")`.

## Consigna que se entrega al alumnado

Cada alumno crea y ejecuta su primer proyecto.

Producto o evidencia que debe quedar: **Captura o documento de primera ejecución.**
...
Pregunta de control: **¿Dónde está el archivo fuente que acabas de ejecutar?**
