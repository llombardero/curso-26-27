# Sesión 206 — Guía operativa del profesorado

## Presentar H1 y delimitar alcance
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Lista de requisitos H1 y lista de restricciones.
...
H1 será lineal: saludo, nombre, mensajes y constantes. No habrá menú ni bucles.
...
| 5–13 min | Explicación breve: H1 busca base sólida, no espectacularidad. No hay menú, bucles, memoria ni IA. |
| 13–18 min | Demostración o ejemplo: Enseña una salida esperada de H1 en consola. |
| 18–35 min | Trabajo del alumnado: Clasificar ideas en tres columnas: H1, más adelante, no adecuado. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿por qué no conviene empezar con IA real? |

## Ejemplo o demostración preparada

Enseña una salida esperada de H1 en consola.

## Consigna que se entrega al alumnado

Clasificar funcionalidades en “H1”, “más adelante” y “no adecuado”.

Producto o evidencia que debe quedar: **Lista de requisitos H1 y lista de restricciones.**
...
Acota el bloqueo con una pregunta y una evidencia pequeña. Evita resolver la actividad por el alumnado.

## Comprobación final

Pregunta de control: **¿Por qué un menú no pertenece todavía a H1?**
