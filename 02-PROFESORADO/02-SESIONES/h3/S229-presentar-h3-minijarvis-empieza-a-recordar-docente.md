...
| Resultado de hoy | Comprender memoria temporal. |
| Evidencia mínima | Lista de necesidades de memoria. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Lista de necesidades de memoria.
...
H2 responde, pero no recuerda. H3 guardará datos mientras el programa está abierto.
...
| 5–13 min | Explicación breve: H3 añade memoria temporal; se pierde al cerrar el programa. |
| 13–18 min | Demostración o ejemplo: Ejecuta H2 y muestra que no recuerda nada. |
| 18–35 min | Trabajo del alumnado: Probar H2 y detectar qué información se pierde. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué debe recordar MiniJarvis en H3? |

## Ejemplo o demostración preparada

Ejecuta H2 y muestra que no recuerda nada.

## Consigna que se entrega al alumnado

Listar qué debería recordar el agente.

Producto o evidencia que debe quedar: **Lista de necesidades de memoria.**
...
Pregunta de control: **¿Qué significa “temporal” en este hito?**
