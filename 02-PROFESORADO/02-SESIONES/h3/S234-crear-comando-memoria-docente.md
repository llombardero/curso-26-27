...
- [ ] Comprobar que la evidencia mínima que se pedirá es: MiniJarvis muestra los recuerdos guardados.
...
Recorrer colección y mostrar datos.
...
| 5–13 min | Explicación breve: Consultar memoria implica recorrer la colección y mostrar contenido. |
| 13–18 min | Demostración o ejemplo: Bucle `for` numerado. |
| 18–35 min | Trabajo del alumnado: Implementar comando `memoria`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué ocurre si no hay recuerdos? |
...
Producto o evidencia que debe quedar: **MiniJarvis muestra los recuerdos guardados.**
...
Pregunta de control: **¿Cómo evitas mostrar una lista vacía sin explicación?**
