...
| Resultado de hoy | Gestionar ausencia de datos. |
| Evidencia mínima | Prueba de `memoria` antes de guardar nada. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Prueba de `memoria` antes de guardar nada.
...
Caso límite y mensaje útil para usuario.
...
| 5–13 min | Explicación breve: Los programas deben responder bien cuando no hay datos. |
| 13–18 min | Demostración o ejemplo: `if (memories.isEmpty())`. |
| 18–35 min | Trabajo del alumnado: Implementar respuesta para memoria vacía. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Añadir caso al plan de pruebas. |
...
Añadir mensaje de memoria vacía.

Producto o evidencia que debe quedar: **Prueba de `memoria` antes de guardar nada.**
...
Pregunta de control: **¿Qué prueba ejecutas antes de guardar nada?**
