...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/comparacion-java-python-h3.md`.
...
Java exige tipos y clases concretas; Python es más flexible.
...
| 5–13 min | Explicación breve: `ArrayList` se parece a `list`; `HashMap` se parece a `dict`. |
| 13–18 min | Demostración o ejemplo: Misma operación en Java y Python. |
| 18–35 min | Trabajo del alumnado: Relacionar `ArrayList` con `list` y `HashMap` con `dict`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué estructura se parece más a tu solución? |

## Ejemplo o demostración preparada

Misma operación en Java y Python.

## Consigna que se entrega al alumnado

Comparar añadir, recorrer y consultar.

Producto o evidencia que debe quedar: **`docs/comparacion-java-python-h3.md`.**
...
Pregunta de control: **¿Qué estructura de Python usarías para tu memoria?**
