...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Pruebas de entrada vacía y repetida.
...
Entrada vacía, espacios y duplicados.
...
| 5–13 min | Explicación breve: Validar entrada evita datos inútiles o confusos. |
| 13–18 min | Demostración o ejemplo: `text.isBlank()`. |
| 18–35 min | Trabajo del alumnado: Evitar guardar recuerdos vacíos y decidir qué hacer con repetidos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué decisión tomaste y por qué? |
...
Decidir y programar política de entradas vacías y repetidas.

Producto o evidencia que debe quedar: **Pruebas de entrada vacía y repetida.**
...
Pregunta de control: **¿Qué hará tu agente si el usuario pulsa Enter sin escribir?**
