...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Ejemplo pequeño de `ArrayList` que compila.
...
Lista, índice, añadir, recorrer y tamaño.
...
| 5–13 min | Explicación breve: `ArrayList` guarda varios elementos en orden y permite recorrerlos. |
| 13–18 min | Demostración o ejemplo: Añadir tres cadenas y mostrarlas numeradas. |
| 18–35 min | Trabajo del alumnado: Mini-reto fuera del proyecto: lista de tareas o palabras. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿por qué una variable simple no basta? |

## Ejemplo o demostración preparada

Añadir tres cadenas y mostrarlas numeradas.

## Consigna que se entrega al alumnado

Mini-lista de tareas.

Producto o evidencia que debe quedar: **Ejemplo pequeño de `ArrayList` que compila.**
...
Pregunta de control: **¿Qué índice tiene el primer elemento?**
