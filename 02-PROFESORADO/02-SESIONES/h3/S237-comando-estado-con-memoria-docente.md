...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `estado` muestra información coherente.
...
Tamaño de colección y mensajes derivados del estado.
...
| 5–13 min | Explicación breve: El estado puede calcularse a partir de datos internos. |
| 13–18 min | Demostración o ejemplo: `memories.size()`. |
| 18–35 min | Trabajo del alumnado: Actualizar `estado` para indicar número de recuerdos. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Probar `estado` antes y después de guardar. |
...
Actualizar `estado` para mostrar número de recuerdos.

Producto o evidencia que debe quedar: **`estado` muestra información coherente.**
...
Pregunta de control: **¿Qué valor muestra si hay cero recuerdos?**
