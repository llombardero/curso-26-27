...
| Resultado de hoy | Validar comportamiento de colecciones. |
| Evidencia mínima | Plan de pruebas H3 ejecutado. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Plan de pruebas H3 ejecutado.
...
Pruebas específicas de memoria: guardar, listar, vacío, repetidos y entradas inválidas.
...
Tabla de prueba para `recuerda` y `memoria`.

## Consigna que se entrega al alumnado

Completar pruebas H3.

Producto o evidencia que debe quedar: **Plan de pruebas H3 ejecutado.**
...
Pregunta de control: **¿Qué caso demuestra que no guardas entradas vacías?**
