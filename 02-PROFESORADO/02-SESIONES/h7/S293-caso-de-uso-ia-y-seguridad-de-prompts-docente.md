...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/riesgos-ia-h7.md` inicial.
...
No enviar datos personales, secretos ni información sensible.
...
| 5–13 min | Explicación breve: La IA debe tener un caso limitado y no recibir datos sensibles. |
| 13–18 min | Demostración o ejemplo: Prompt seguro e inseguro. |
| 18–35 min | Trabajo del alumnado: Diseñar caso: sugerencia de estudio o explicación breve. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar qué datos recibe la IA o simulación. |

## Ejemplo o demostración preparada

Prompt seguro e inseguro.

## Consigna que se entrega al alumnado

Diseñar caso de uso y riesgos.

Producto o evidencia que debe quedar: **`docs/riesgos-ia-h7.md` inicial.**
...
Pregunta de control: **¿Qué datos no enviarás nunca?**
