...
La IA no se acepta sin revisión humana.
...
| 5–13 min | Explicación breve: Toda respuesta de IA debe validarse; no se acepta automáticamente. |
| 13–18 min | Demostración o ejemplo: Registro: prompt, respuesta, aceptación, modificación, verificación. |
| 18–35 min | Trabajo del alumnado: Completar registro de prompts y validación. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué respuesta podría ser incorrecta o peligrosa? |

## Ejemplo o demostración preparada

Registro: prompt, respuesta, aceptación, modificación, verificación.
...
Pregunta de control: **¿Qué respuesta no aceptarías sin revisar?**
