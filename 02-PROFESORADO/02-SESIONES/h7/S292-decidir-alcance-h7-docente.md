...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Decisión H7 documentada.
...
La simulación robusta es válida si evita fragilidad o riesgos de claves.
...
| 5–13 min | Explicación breve: La simulación robusta es una opción válida y segura. |
| 13–18 min | Demostración o ejemplo: Comparar riesgos de API real frente a simulador local. |
| 18–35 min | Trabajo del alumnado: Evaluar preparación del equipo y decidir alcance. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué opción es más segura y defendible para tu equipo? |

## Ejemplo o demostración preparada

Comparar riesgos de API real frente a simulador local.

## Consigna que se entrega al alumnado

Elegir alcance del equipo.

Producto o evidencia que debe quedar: **Decisión H7 documentada.**
...
Pregunta de control: **¿Qué opción es más defendible para tu equipo?**
