...
La IA debe estar limitada, validada y documentada.
...
| 5–13 min | Explicación breve: Defender IA significa explicar qué hace, qué no hace, qué datos recibe y qué riesgos tiene. |
| 13–18 min | Demostración o ejemplo: Preguntas de defensa IA. |
| 18–35 min | Trabajo del alumnado: Demo H7 y defensa individual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Congelar versión base para HF. |

## Ejemplo o demostración preparada

Preguntas de defensa IA.
...
Pregunta de control: **¿Dónde están los límites de tu modo IA? ---**
