...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Modo IA funcional o simulación robusta.
...
`AiAssistant`, `SimulatedAiAssistant`, `AiTool` y validación.
...
| 5–13 min | Explicación breve: Lo importante es que el modo IA sea controlado, no espectacular. |
| 13–18 min | Demostración o ejemplo: `SimulatedAiAssistant` con respuestas y bloqueo de secretos. |
| 18–35 min | Trabajo del alumnado: Implementar clase simulada o integración segura. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Probar respuesta válida y respuesta rechazada. |

## Ejemplo o demostración preparada

`SimulatedAiAssistant` con respuestas y bloqueo de secretos.

## Consigna que se entrega al alumnado

Implementar simulación o integración segura.

Producto o evidencia que debe quedar: **Modo IA funcional o simulación robusta.**
...
Pregunta de control: **¿Qué hace tu agente si detecta una contraseña?**
