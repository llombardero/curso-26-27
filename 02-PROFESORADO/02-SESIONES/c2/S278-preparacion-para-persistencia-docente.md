# Sesión 278 — Guía operativa del profesorado
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Boceto de persistencia H6.
...
La memoria temporal desaparece al cerrar; la persistencia resuelve eso.
...
| 5–13 min | Explicación breve: La persistencia permite que la memoria sobreviva entre ejecuciones. |
| 13–18 min | Demostración o ejemplo: Cerrar el programa y perder recuerdos. |
| 18–35 min | Trabajo del alumnado: Diseñar qué debe guardarse en disco. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué riesgos aparecen al guardar datos? |

## Ejemplo o demostración preparada

Cerrar el programa y perder recuerdos.

## Consigna que se entrega al alumnado

Diseñar qué datos guardar.

Producto o evidencia que debe quedar: **Boceto de persistencia H6.**
...
Pregunta de control: **¿Qué riesgos aparecen al guardar datos? ---**
