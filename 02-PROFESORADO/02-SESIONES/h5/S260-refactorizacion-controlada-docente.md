...
Antes/después, motivo y prueba posterior.
...
| 5–13 min | Explicación breve: Refactorizar mejora estructura sin cambiar comportamiento. |
| 13–18 min | Demostración o ejemplo: Extraer método o renombrar variable y ejecutar pruebas. |
| 18–35 min | Trabajo del alumnado: Aplicar una refactorización pequeña. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Ejecutar prueba que demuestre que no se rompió. |

## Ejemplo o demostración preparada

Extraer método o renombrar variable y ejecutar pruebas.
...
Pregunta de control: **¿Qué prueba demuestra que el comportamiento no cambió?**
