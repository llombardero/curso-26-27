...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `docs/comparacion-java-python-h5.md`.
...
Java formaliza contratos; Python puede usar convenciones.
...
| 5–13 min | Explicación breve: Java formaliza contratos; Python puede funcionar por convenciones o duck typing. |
| 13–18 min | Demostración o ejemplo: Interfaz Java frente a clase Python con método esperado. |
| 18–35 min | Trabajo del alumnado: Comparar una herramienta Java con equivalente Python. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué pierde y qué gana cada lenguaje? |

## Ejemplo o demostración preparada

Interfaz Java frente a clase Python con método esperado.

## Consigna que se entrega al alumnado

Comparar herramienta Java/Python.

Producto o evidencia que debe quedar: **`docs/comparacion-java-python-h5.md`.**
...
Pregunta de control: **¿Qué ventaja tiene la interfaz en Java?**
