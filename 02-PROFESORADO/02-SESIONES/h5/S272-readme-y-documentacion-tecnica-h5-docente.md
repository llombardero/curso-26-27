...
- [ ] Comprobar que la evidencia mínima que se pedirá es: README H5.
...
README debe explicar cómo añadir una herramienta.
...
| 5–13 min | Explicación breve: Documentar H5 implica explicar cómo se añade una herramienta. |
| 13–18 min | Demostración o ejemplo: Apartado “Cómo añadir una nueva Tool”. |
| 18–35 min | Trabajo del alumnado: Actualizar README con estructura, herramientas y ejecución. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Otro equipo intenta entender cómo añadir una herramienta. |

## Ejemplo o demostración preparada

Apartado “Cómo añadir una nueva Tool”.

## Consigna que se entrega al alumnado

Actualizar README.

Producto o evidencia que debe quedar: **README H5.**
...
Pregunta de control: **¿Podría otro equipo añadir una herramienta leyendo tu README?**
