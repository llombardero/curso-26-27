...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Comando recordar funciona como herramienta.
...
Composición: una clase usa otra para cumplir su tarea.
...
| 5–13 min | Explicación breve: Las herramientas pueden necesitar colaborar con otros objetos. |
| 13–18 min | Demostración o ejemplo: `RememberTool` usa `Memory`. |
| 18–35 min | Trabajo del alumnado: Crear `RememberTool` usando `Memory`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar dependencias: qué necesita `RememberTool`. |

## Ejemplo o demostración preparada

`RememberTool` usa `Memory`.

## Consigna que se entrega al alumnado

Implementar guardar recuerdo como herramienta.

Producto o evidencia que debe quedar: **Comando recordar funciona como herramienta.**
...
Pregunta de control: **¿Qué dependencia necesita `RememberTool`?**
