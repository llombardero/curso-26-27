...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Comando ayuda funciona mediante herramienta.
...
Delegación: `Agent` no tiene que saber todos los detalles.
...
| 5–13 min | Explicación breve: `Agent` delega en herramientas para no crecer indefinidamente. |
| 13–18 min | Demostración o ejemplo: `HelpTool.execute()` muestra comandos. |
| 18–35 min | Trabajo del alumnado: Crear `HelpTool`. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué código salió de `Agent`? |

## Ejemplo o demostración preparada

`HelpTool.execute()` muestra comandos.

## Consigna que se entrega al alumnado

Extraer ayuda a clase propia.

Producto o evidencia que debe quedar: **Comando ayuda funciona mediante herramienta.**
...
Pregunta de control: **¿Qué código salió de `Agent`?**
