# Sesión 261 — Guía operativa del profesorado
...
| Resultado de hoy | Separar comandos como herramientas. |
| Evidencia mínima | Tabla de herramientas y responsabilidad. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Tabla de herramientas y responsabilidad.
...
Una herramienta tiene nombre, descripción y ejecución.
...
| 5–13 min | Explicación breve: Una herramienta encapsula una acción del agente. |
| 13–18 min | Demostración o ejemplo: `HelpTool`, `RememberTool`, `MemoryTool`. |
| 18–35 min | Trabajo del alumnado: Diseñar lista de herramientas: ayuda, recordar, memoria, estado. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué herramienta añadirías sin tocar memoria? |

## Ejemplo o demostración preparada

`HelpTool`, `RememberTool`, `MemoryTool`.

## Consigna que se entrega al alumnado

Tabla de herramientas y responsabilidades.

Producto o evidencia que debe quedar: **Tabla de herramientas y responsabilidad.**
...
Pregunta de control: **¿Qué responsabilidad tiene `HelpTool`?**
