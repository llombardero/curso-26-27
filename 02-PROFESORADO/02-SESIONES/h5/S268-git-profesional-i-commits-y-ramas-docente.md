# Sesión 268 — Guía operativa del profesorado
...
Commit pequeño, mensaje claro, rama de trabajo y autoría.
...
| 5–13 min | Explicación breve: Git permite trazabilidad y recuperación. Un commit debe explicar un cambio coherente. |
| 13–18 min | Demostración o ejemplo: Mensajes malos y buenos de commit. |
| 18–35 min | Trabajo del alumnado: Crear evidencia de commits o registro equivalente si no hay GitHub. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar un commit: qué cambia y por qué. |

## Ejemplo o demostración preparada

Mensajes malos y buenos de commit.
...
Pregunta de control: **¿Qué cambio demuestra tu último commit?**
