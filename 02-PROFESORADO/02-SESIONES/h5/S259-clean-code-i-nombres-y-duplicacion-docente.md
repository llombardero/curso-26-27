...
| Resultado de hoy | Detectar problemas de legibilidad. |
| Evidencia mínima | Lista de mejoras priorizadas. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Lista de mejoras priorizadas.
...
Nombres claros, duplicación y métodos demasiado largos.
...
| 5–13 min | Explicación breve: Código limpio es código que se entiende y se cambia con menos riesgo. |
| 13–18 min | Demostración o ejemplo: Mal nombre `x` frente a `command`. |
| 18–35 min | Trabajo del alumnado: Revisar código con checklist de clean code. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Elegir una mejora concreta para aplicar. |

## Ejemplo o demostración preparada

Mal nombre `x` frente a `command`.

## Consigna que se entrega al alumnado

Checklist de nombres, duplicación y tamaño.

Producto o evidencia que debe quedar: **Lista de mejoras priorizadas.**
...
Pregunta de control: **¿Qué nombre mejorarías hoy?**
