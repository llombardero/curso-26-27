...
| Resultado de hoy | Completar herramientas principales. |
| Evidencia mínima | Agente funciona con varias herramientas. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Agente funciona con varias herramientas.
...
Repetir estructura permite detectar abstracción útil.
...
| 5–13 min | Explicación breve: Repetir la misma estructura permite crear una familia de herramientas. |
| 13–18 min | Demostración o ejemplo: Dos herramientas con mismo contrato y distinta acción. |
| 18–35 min | Trabajo del alumnado: Extraer memoria y estado a herramientas separadas. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué se repite entre herramientas? |

## Ejemplo o demostración preparada

Dos herramientas con mismo contrato y distinta acción.

## Consigna que se entrega al alumnado

Extraer memoria y estado.

Producto o evidencia que debe quedar: **Agente funciona con varias herramientas.**
...
Pregunta de control: **¿Qué tienen en común las herramientas?**
