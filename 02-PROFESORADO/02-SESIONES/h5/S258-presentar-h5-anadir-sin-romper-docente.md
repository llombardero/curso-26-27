...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Diagnóstico de rigidez del diseño H4.
...
Un diseño extensible permite añadir comandos con bajo impacto.
...
| 5–13 min | Explicación breve: Un diseño extensible reduce cambios necesarios para añadir funcionalidad. |
| 13–18 min | Demostración o ejemplo: Pregunta: para añadir `resumen`, ¿qué archivos tocaríamos? |
| 18–35 min | Trabajo del alumnado: Preguntar qué archivos habría que tocar para añadir una herramienta. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Pregunta: ¿qué cambio se repite cada vez que añadimos comando? |

## Ejemplo o demostración preparada

Pregunta: para añadir `resumen`, ¿qué archivos tocaríamos?

## Consigna que se entrega al alumnado

Diagnóstico de rigidez.

Producto o evidencia que debe quedar: **Diagnóstico de rigidez del diseño H4.**
...
Pregunta de control: **¿Qué parte del diseño se repite demasiado?**
