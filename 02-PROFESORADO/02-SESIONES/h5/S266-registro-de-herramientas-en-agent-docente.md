...
| Resultado de hoy | Orquestar herramientas sin condicional gigante. |
| Evidencia mínima | Añadir herramienta requiere bajo impacto. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Añadir herramienta requiere bajo impacto.
...
Mapa o lista de herramientas, búsqueda por nombre y ejecución.
...
| 5–13 min | Explicación breve: El agente puede buscar una herramienta por nombre en vez de tener un condicional enorme. |
| 13–18 min | Demostración o ejemplo: Mapa `nombre -> Tool`. |
| 18–35 min | Trabajo del alumnado: Registrar herramientas y ejecutar según comando. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Probar añadir una herramienta mínima nueva. |
...
Registrar herramientas y ejecutar por comando.

Producto o evidencia que debe quedar: **Añadir herramienta requiere bajo impacto.**
...
Pregunta de control: **¿Qué cambia para añadir una herramienta nueva?**
