...
| Resultado de hoy | Defender extensibilidad, refactorización, Git y patrón. |
| Evidencia mínima | Defensa H5 completa. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Defensa H5 completa.
...
No se evalúa usar patrón, sino decidir con criterio.
...
| 5–13 min | Explicación breve: La defensa debe mostrar extensibilidad, refactorización y criterio sobre patrones. |
| 13–18 min | Demostración o ejemplo: Añadir una herramienta mínima en directo o explicar cómo hacerlo. |
| 18–35 min | Trabajo del alumnado: Demo, defensa individual y revisión de evidencias. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Preparar lista de pendientes para C2. |

## Ejemplo o demostración preparada

Añadir una herramienta mínima en directo o explicar cómo hacerlo.

## Consigna que se entrega al alumnado

Demo y defensa.

Producto o evidencia que debe quedar: **Defensa H5 completa.**
...
Pregunta de control: **¿Puedes añadir una herramienta sin tocar muchas clases? --- ## C2 — Cierre segunda evaluación**
