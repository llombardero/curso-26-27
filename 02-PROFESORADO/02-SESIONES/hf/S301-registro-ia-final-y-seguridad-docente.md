...
| Resultado de hoy | Cerrar trazabilidad de IA. |
| Evidencia mínima | Registro IA final. |
...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Registro IA final.
...
Todo uso de IA evaluable debe quedar declarado.
...
| 40–45 min | Cierre: Pregunta: ¿qué parte del proyecto no podrías defender si no registras IA? |

## Ejemplo o demostración preparada

Revisar un registro incompleto y corregirlo.

## Consigna que se entrega al alumnado

Completar registros faltantes.

Producto o evidencia que debe quedar: **Registro IA final.**
...
Pregunta de control: **¿Qué uso de IA afectó más a tu proyecto?**
