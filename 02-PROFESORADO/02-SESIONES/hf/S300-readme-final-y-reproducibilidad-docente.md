...
- [ ] Comprobar que la evidencia mínima que se pedirá es: README final validado.
...
README final debe incluir requisitos, ejecución, estructura, comandos, límites y seguridad.
...
| 5–13 min | Explicación breve: El README final debe permitir ejecutar y entender el proyecto completo. |
| 13–18 min | Demostración o ejemplo: Checklist de README final. |
| 18–35 min | Trabajo del alumnado: Actualizar README final y probar desde cero. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Otro equipo intenta seguir instrucciones. |

## Ejemplo o demostración preparada

Checklist de README final.

## Consigna que se entrega al alumnado

Probar README desde cero.

Producto o evidencia que debe quedar: **README final validado.**
...
Pregunta de control: **¿Qué necesita instalar o abrir una persona externa?**
