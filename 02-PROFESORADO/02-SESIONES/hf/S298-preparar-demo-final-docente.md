...
- [ ] Comprobar que la evidencia mínima que se pedirá es: Guion de demo final.
...
Una demo debe mostrar evolución, no solo resultado final.
...
| 5–13 min | Explicación breve: Una buena demo cuenta evolución y decisiones, no solo enseña una pantalla. |
| 13–18 min | Demostración o ejemplo: Guion: problema, evolución, demo, pruebas, límites. |
| 18–35 min | Trabajo del alumnado: Preparar guion de demo: H1, H2, H3, H4, H5, H6 y H7 si procede. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Ensayo rápido de 3 minutos por equipo. |

## Ejemplo o demostración preparada

Guion: problema, evolución, demo, pruebas, límites.

## Consigna que se entrega al alumnado

Preparar guion de demo.

Producto o evidencia que debe quedar: **Guion de demo final.**
...
Pregunta de control: **¿Qué hito demuestra mejor vuestra evolución?**
