...
- [ ] Comprobar que la evidencia mínima que se pedirá es: `portfolio-final.md`.
...
Portfolio no es una carpeta de archivos; es relato técnico con evidencias.
...
| 5–13 min | Explicación breve: El portfolio es relato técnico con evidencias, no acumulación de archivos. |
| 13–18 min | Demostración o ejemplo: Afirmación sin evidencia frente a afirmación con enlace/captura/código. |
| 18–35 min | Trabajo del alumnado: Completar portfolio final individual. |
| 35–40 min | Comprobar la evidencia con una explicación o prueba breve. |
| 40–45 min | Cierre: Revisar si cada afirmación tiene evidencia. |

## Ejemplo o demostración preparada

Afirmación sin evidencia frente a afirmación con enlace/captura/código.

## Consigna que se entrega al alumnado

Completar portfolio.

Producto o evidencia que debe quedar: **`portfolio-final.md`.**
...
Pregunta de control: **¿Cada aprendizaje importante tiene evidencia?**
