...
Decisiones, repetición y depuración.
...
| Evidencias no-code | Carpeta `H2` del equipo en Drive |
...
Código; pruebas; depuración reproducible; incidencia; comparación Java/Python; defensa.

## Versión evaluada

Tag o commit `h2-entrega`.

## Entrega en Moodle

- enlace profundo a la página `H2` del Site personal;
- enlace profundo a la página `H2` del Site del equipo;
- enlace a la pestaña o evidencia concreta del Sheet Scrum;
- enlace a la carpeta `H2` de Drive cuando sea necesario;
