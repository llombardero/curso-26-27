...
3. Realiza esta tarea: **Crear o ajustar `PersistentMemory`.**
...
- [ ] He producido o actualizado: **Persistencia encapsulada en clase propia.**
...
Responde sin copiar: **Pregunta: ¿por qué no ponemos todo en `Agent`?**
