...
|---|---|
| Evitar secretos y datos personales. | `docs/seguridad-h6.md`. |
...
3. Realiza esta tarea: **Revisar repositorio y ficheros de ejemplo.**
...
- [ ] He producido o actualizado: **`docs/seguridad-h6.md`.**
...
Responde sin copiar: **Checklist de seguridad pasado.**
