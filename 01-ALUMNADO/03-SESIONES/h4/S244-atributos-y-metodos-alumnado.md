...
3. Realiza esta tarea: **Diseñar tarjeta CRC simple de `Agent` y `Memory`.**
...
- [ ] He producido o actualizado: **Tabla: clase, atributos, métodos y responsabilidad.**
...
Responde sin copiar: **Pregunta: ¿qué sabe `Memory` y qué hace `Memory`?**
