...
3. Realiza esta tarea: **Analizar relación `Agent` -> `Memory`.**
...
- [ ] He producido o actualizado: **Descripción textual de relaciones del diseño.**
...
Responde sin copiar: **Pregunta: ¿quién debe guardar recuerdos, `Agent` o `Memory`?**
