...
3. Realiza esta tarea: **Añadir a `Memory` un constructor por defecto y otro que reciba recuerdos iniciales ficticios; documentar con Javadoc una clase y dos métodos públicos.**
...
- [ ] He producido o actualizado: **Código con constructores sobrecargados y apartado en README/portfolio explicando cuándo se usa cada uno.**
...
Responde sin copiar: **Pregunta: ¿qué constructor se ejecuta en tu `Main`?**
