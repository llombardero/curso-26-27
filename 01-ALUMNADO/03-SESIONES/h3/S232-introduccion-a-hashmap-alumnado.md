...
3. Realiza esta tarea: **Crear un array con tres comandos conocidos, comparar sus limitaciones con `ArrayList`, y usar `Set<String>` para detectar recuerdos repetidos o justificar por qué no se incorpora al diseño final.**
...
Responde sin copiar: **Pregunta: ¿qué estructura usarías si no quieres repetidos?**
