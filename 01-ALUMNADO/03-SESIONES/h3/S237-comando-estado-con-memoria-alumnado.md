...
3. Realiza esta tarea: **Actualizar `estado` para indicar número de recuerdos.**
...
- [ ] He producido o actualizado: **`estado` muestra información coherente.**
...
Responde sin copiar: **Probar `estado` antes y después de guardar.**
