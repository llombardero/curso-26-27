# Sesión 234 — Ficha de trabajo del alumnado

## Crear comando `memoria`

| Hoy vas a… | Debe quedar… |
|---|---|
| Consultar información guardada. | MiniJarvis muestra los recuerdos guardados. |
...
3. Realiza esta tarea: **Implementar comando `memoria`.**
...
- [ ] He producido o actualizado: **MiniJarvis muestra los recuerdos guardados.**
...
Responde sin copiar: **Pregunta: ¿qué ocurre si no hay recuerdos?**
