...
3. Realiza esta tarea: **Crear variable `userName` con un valor fijo y usarla en varios mensajes.**
...
- [ ] He producido o actualizado: **Código con variable usada correctamente.**
...
Responde sin copiar: **Pregunta: ¿qué cambia si modifico el valor de la variable?**
