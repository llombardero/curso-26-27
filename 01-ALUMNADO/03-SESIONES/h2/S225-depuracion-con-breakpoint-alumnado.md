...
3. Realiza esta tarea: **Poner breakpoint tras leer `command` y observar `command`, `running`, `userName`.**
...
Responde sin copiar: **Pregunta: ¿qué valor tenía `command` antes de entrar en el condicional?**
