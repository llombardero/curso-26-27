# Sesión 222 — Ficha de trabajo del alumnado
...
3. Realiza esta tarea: **Implementar `salir` modificando `running`.**
...
- [ ] He producido o actualizado: **El programa termina solo cuando se escribe `salir`.**
...
Responde sin copiar: **Prueba oral: ¿qué línea provoca la salida?**
