...
|---|---|
| Documentar un fallo real y su solución. | `docs/incidencia-h2.md`. |
...
- [ ] He producido o actualizado: **`docs/incidencia-h2.md`.**
...
Responde sin copiar: **Compartir una incidencia útil con la clase.**
