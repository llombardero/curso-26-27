...
|---|---|
| Revisar código de forma constructiva. | `docs/revision-codigo-h5.md`. |
...
3. Realiza esta tarea: **Revisión cruzada por equipos con checklist.**
...
- [ ] He producido o actualizado: **`docs/revision-codigo-h5.md`.**
...
Responde sin copiar: **Cada equipo acepta o rechaza una sugerencia justificando.**
