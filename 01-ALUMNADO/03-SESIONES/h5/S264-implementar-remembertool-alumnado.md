...
3. Realiza esta tarea: **Crear `RememberTool` usando `Memory`.**
...
- [ ] He producido o actualizado: **Comando recordar funciona como herramienta.**
...
Responde sin copiar: **Revisar dependencias: qué necesita `RememberTool`.**
