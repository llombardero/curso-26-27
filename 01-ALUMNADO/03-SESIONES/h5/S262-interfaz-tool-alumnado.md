...
3. Realiza esta tarea: **Crear `Tool` con métodos simples como `name()` y `execute()`.**
...
- [ ] He producido o actualizado: **Primera herramienta implementa `Tool`.**
...
Responde sin copiar: **Microdefensa: ¿qué obliga a hacer la interfaz?**
